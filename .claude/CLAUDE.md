...
Webhook delivery, refresh tokens, user-level notification preferences.

## Project context

- 6-week project, 5 interns, one component owned per intern.
- "Owns" means responsible for / coordinates on — others may still contribute.